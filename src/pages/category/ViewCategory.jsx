...
import { getCategoriesById } from '../../apis/apis'
...
export const ViewCategory = () => {
    ...
    useEffect(() => {
        getCategoriesById(id).then(result => {
    ...
    return (
        <AdminLayout>
            <Container fluid="true">
                <Row>
                    <Col sm={3}><p className='page_left_panel'>View Category</p></Col>
                    <Col sm={5}></Col>
                    <Col sm={4}><p className='page_right_panel'><span style={{ cursor: 'pointer' }} onClick={handleNavigate}>Category List</span> / View Category</p></Col>
                </Row>
                    ...
                    <Form style={{ padding: '25px 20px 25px 25px' }}>
                        <Row className="g-2" style={row_style}>
                            <Col md>
                                ...
                                <Form.Control defaultValue={state.category} type="text" disabled />
                            </Col>
                            <Col md>
