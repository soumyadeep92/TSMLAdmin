...
export const ListUserPlant = () => {
  ...
  const columns = React.useMemo(
      () => [
          ...
          { Header: 'User Plant', accessor: 'userplant' },
  ...
  const addUserPlant = ()=>{
    navigate('/add-user-plant');
  }
  return (
    <AdminLayout>
        <Container fluid="true">
                <Row>
                    <Col sm={3}><p style={{ fontSize: "30px", fontWeight: "bold", fontFamily: "Mulish", marginTop: "20px" }}>List User Plant</p></Col>
                    <Col sm={6}></Col>
                    <Col sm={3}><p style={{ fontSize: "20px", fontFamily: "Mulish", marginTop: "25px" }}><Link to="/dashboard" style={{ textDecoration: 'none' }}>Dashboard</Link> / <Link to="/list-user-plant" style={{ textDecoration: 'none' }}>List User Plant</Link></p></Col>
                </Row>
                ...
                <Row className="g-2" style={{ marginLeft: "629px" }}>
                    ...
                    <Col md>
                        <Button onClick={addUserPlant} style={submitbuttonStyle}>Add User Plant</Button>
                    </Col>
                </Row>
            </Container>
    </AdminLayout>
