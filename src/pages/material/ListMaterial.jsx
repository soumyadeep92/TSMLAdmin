...
import { listMaterials, deleteMaterial } from '../../apis/apis'
...
export const ListMaterial = () => {
    ...
    const handleView = (item) => {
        ...
        navigate('/view-material/' + item);
    };
    const handleEdit = (item) => {
        navigate('/edit-material/' + item);
    };
    const handleDelete = async (item) => {
        let result = await deleteMaterial(item)
            ...
            <AdminLayout>
                <Container fluid="true">
                    <Row>
                        ...
                        <Col sm={5}></Col>
                        <Col sm={4}><p className='page_right_panel'><span style={{ cursor: 'pointer' }} onClick={handleNavigate}>Dashboard</span> / List Material</p></Col>
                    </Row>
