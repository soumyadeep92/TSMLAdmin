...
export const ListReason = () => {
  ...
  const columns = React.useMemo(
      () => [
          ...
          { Header: 'Delevery', accessor: 'delevery' },
    ...
    <AdminLayout>
        <Container fluid="true">
                <Row>
                    ...
                    <Col sm={6}></Col>
                    <Col sm={3}><p style={{ fontSize: "20px", fontFamily: "Mulish", marginTop: "25px" }}><Link to="/dashboard" style={{ textDecoration: 'none' }}>Dashboard</Link> / <Link to="/list-reason" style={{ textDecoration: 'none' }}>List Reason</Link></p></Col>
                </Row>
