...
export const AddCustomer = () => {
    ...
    const addCustomer = async () => {
        if (!state.user_code || !state.name || !state.email || !state.phone_number || !state.organization_name || !state.organization_GSTN || !state.organization_address_registered || !state.organization_address_plant || !state.business_nature) {
            setError(true)
            return false;
        }
        if (file) {
        ...
        <>
            ...
            <AdminLayout>
                ...
                <Container fluid="true">
                    <Row>
                        <Col sm={3}><p className='page_left_panel'>Add Customer</p></Col>
                        <Col sm={5}></Col>
                        <Col sm={4}><p className='page_right_panel'><span style={{ cursor: 'pointer' }} onClick={handleNavigate}>Customer List</span> / Add Customer</p></Col>
                    </Row>
                    ...
                    <Row className="g-2" style={{ marginLeft: "629px" }}>
                        ...
                        <Col md>
                            <Button onClick={addCustomer} style={submitbuttonStyle}>Add</Button>
                        </Col>
                    </Row>
                </Container>
