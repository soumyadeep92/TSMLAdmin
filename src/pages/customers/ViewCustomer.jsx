...
import { getCustomerById } from '../../apis/apis'
                    ...
                    <Form style={{ padding: '25px 20px 25px 25px' }}>
                        <Row className="g-2">
                            <Col md>
                                ...
                                <Form.Control value={state.user_code ? state.user_code : ''} type="text" disabled />
                            </Col>
                            <Col md>
                                <Form.Label>Name</Form.Label>
                                <Form.Control value={state.name ? state.name : ''} type="text" disabled />
                            </Col>
                        </Row>
                        <Row className="g-2" style={row_style}>
                            <Col md>
                                <Form.Label>Email</Form.Label>
                                <Form.Control value={state.email ? state.email : ''} type="email" disabled />
                            </Col>
                            <Col md>
                                <Form.Label>Phone No.</Form.Label>
                                <Form.Control value={state.phone_number ? state.phone_number : ''} type="text" disabled />
                            </Col>
                        </Row>
                        <Row className="g-2" style={row_style}>
                            <Col md>
                                <Form.Label>Organization Name</Form.Label>
                                <Form.Control value={state.organization_name ? state.organization_name : ''} type="text" disabled />
                            </Col>
                            <Col md>
                                <Form.Label>Organization PAN</Form.Label>
                                <Form.Control value={state.organization_PAN ? state.organization_PAN : ''} type="text" disabled />
                            </Col>
                        </Row>
                        <Row className="g-2" style={row_style}>
                            <Col md>
                                <Form.Label>Organization GSTN</Form.Label>
                                <Form.Control value={state.organization_GSTN ? state.organization_GSTN : ''} type="text" disabled />
                            </Col>
                            <Col md>
                                <Form.Label>Organization Registered Address</Form.Label>
                                <Form.Control value={state.organization_address_registered ? state.organization_address_registered : ''} type="text" disabled />
                            </Col>
                        </Row>
                        <Row className="g-2" style={row_style}>
                            <Col md>
                                <Form.Label>Organization Plant Address</Form.Label>
                                <Form.Control value={state.organization_address_plant ? state.organization_address_plant : ''} type="text" disabled />
                            </Col>
                            <Col md>
                                <Form.Label>Address</Form.Label>
                                <Form.Control value={state.address ? state.address : ''} type="text" disabled />
                            </Col>
                        </Row>
                        <Row className="g-2" style={row_style}>
                            <Col md>
                                <Form.Label>State</Form.Label>
                                <Form.Control value={state.state ? state.state : ''} type="text" disabled />
                            </Col>
                            <Col md>
                                <Form.Label>City</Form.Label>
                                <Form.Control value={state.city ? state.city : ''} type="text" disabled />
                            </Col>
                        </Row>
                        <Row className="g-2" style={row_style}>
                            <Col md>
                                <Form.Label>Pin Code</Form.Label>
                                <Form.Control value={state.pin_code ? state.pin_code : ''} type="text" disabled />
                            </Col>
                            <Col md>
                                <Form.Label>Zone</Form.Label>
                                <Form.Select aria-label="Floating label select example" value={state.zone ? state.zone : ''} disabled>
                                </Form.Select>
                            </Col>
                        </Row>
                        <Row className="g-2" style={row_style}>
                            <Col md>
                                ...
                                <Form.Select aria-label="Floating label select example" value={state.customer_type ? state.customer_type : ''} disabled>
                                </Form.Select>
                            </Col>
                            <Col md>
                                <Form.Label>Business Nature</Form.Label>
                                <Form.Control value={state.business_nature ? state.business_nature : ''} type="text" disabled />
                            </Col>
                        </Row>
                        <Row className="g-2" style={row_style}>
                            <Col md>
                                ...
                                <InputGroup>
                                    ...
                                    <Form.Control value={state.profile_image ? state.profile_image : ''} disabled />
                                    <InputGroup.Text style={{ cursor: "pointer" }}>Browse</InputGroup.Text>
                                </InputGroup>
                            </Col>
                            <Col md>
                                <Form.Label>Status</Form.Label>
                                <Form.Control defaultValue={state.status ? state.status : ''} type="text" disabled />
                            </Col>
                        </Row>
                        {state.profile_image && typeof state.profile_image === 'string' &&
                            <Row className="g-2" style={row_style}>
                                <Col lg="6" style={{ textAlign: 'left' }}>
                                    <Image style={{ width: '80px', height: '80px' }} src={state.profile_image} />
                                </Col>
                                <Col md></Col>
                            </Row>
                        }
