...
export const ListStandard = () => {
    ...
    const columns = React.useMemo(
        () => [
            ...
            { Header: 'Standard Name', accessor: 'standard' },
    ...
    const addstandard = () => {
        navigate('/add-standard');
    }
    return (
        <AdminLayout>
            <Container fluid="true">
                <Row>
                    <Col sm={3}><p style={{ fontSize: "30px", fontWeight: "bold", fontFamily: "Mulish", marginTop: "20px" }}>List Standard</p></Col>
                    <Col sm={6}></Col>
                    <Col sm={3}><p style={{ fontSize: "20px", fontFamily: "Mulish", marginTop: "25px" }}><Link to="/dashboard" style={{ textDecoration: 'none' }}>Dashboard</Link> / <Link to="/list-cvr-mode" style={{ textDecoration: 'none' }}>List Standard</Link></p></Col>
                </Row>
