        ...
        getReasonById(id).then(result => {
            if (result.response.status === true && result.response.data) {
                ...
                itemElements = {
                    ...
                    reason_name: result.response.data.reason_name,
                ...
                setState(
                    {
                        ...
                        reason_name: itemElements.reason_name,
        ...
        <AdminLayout>
            <Container fluid="true">
                <Row>
                    ...
                    <Col sm={5}></Col>
                    <Col sm={4}><p className='page_right_panel'><span style={{ cursor: 'pointer' }} onClick={handleNavigate}>Reason List</span> / View Reason</p></Col>
                </Row>
                    ...
                    <Form style={{ padding: '25px 20px 25px 25px' }}>
                        <Row className="g-2" style={row_style}>
                            <Col md>
                                ...
                                <Form.Control defaultValue={state.reason_name} type="text" disabled />
                            </Col>
                            <Col md>
