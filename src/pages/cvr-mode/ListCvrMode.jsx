    ...
    return (
        <>
            {show1 && (
                ...
                >
                    CVR mode not deleted
                </SweetAlert>
            )}
            {showAlert && (
                <SweetAlert
                    success
                    title="CVR mode Deleted!"
                    onConfirm={handleClose}
                    confirmBtnBsStyle="success"
                >
                    CVR mode deleted successfully
                </SweetAlert>
            )}
            <AdminLayout>
                <Container fluid="true">
                    <Row>
                        <Col sm={3}><p className='page_left_panel'>List Cvr Mode</p></Col>
                        <Col sm={5}></Col>
                        <Col sm={4}><p className='page_right_panel'><span style={{ cursor: 'pointer' }} onClick={handleNavigate}>Dashboard</span> / List Cvr Mode</p></Col>
                    </Row>
