...
export const ListProduct = () => {
    ...
    const getApiDatas = async () => {
        let result = await fetchWithAuth(`${ADMIN_BACKEND_BASE_URL}${ADMIN_BACKEND_CUSTOMER_API_URL}list-product`, {
            method: 'get',
            headers: {
                'Content-Type': 'application/json',
            }
    ...
    return (
        <AdminLayout>
            <Container fluid="true">
                <Row>
                    <Col sm={3}><p style={{ fontSize: "30px", fontWeight: "bold", fontFamily: "Mulish", marginTop: "20px" }}>List product</p></Col>
                    <Col sm={6}></Col>
                    <Col sm={3}><p style={{ fontSize: "20px", fontFamily: "Mulish", marginTop: "25px" }}><Link to="/dashboard" style={{ textDecoration: 'none' }}>Dashboard</Link> / <Link to="/list-cvr-mode" style={{ textDecoration: 'none' }}>List product</Link></p></Col>
                </Row>
                ...
                <Row className="g-2" style={{ marginLeft: "629px" }}>
                    ...
                    <Col md>
                        <Button onClick={addproduct} style={submitbuttonStyle}>Add product</Button>
                    </Col>
                </Row>
            </Container>
        </AdminLayout>
