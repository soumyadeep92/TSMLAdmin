...
export const AddProduct = () => {
    ...
    const addProduct = async () => {
        ...
        if (products.response.status == false) {
            ...
            setShow2(true)
            setShowExistMessage(products.response.message)
        }
    }
        ...
        <>
            ...
            <AdminLayout>
                <Container fluid="true">
                    <Row>
                        <Col sm={3}><p className='page_left_panel'>Add Product</p></Col>
                        <Col sm={5}></Col>
                        <Col sm={4}><p className='page_right_panel'><span style={{ cursor: 'pointer' }} onClick={handleNavigate}>Product List</span> / Add Product</p></Col>
                    </Row>
